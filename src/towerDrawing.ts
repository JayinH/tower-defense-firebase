...
class TowerDrawing {
  constructor(){}
  private static arrowHTML = document.getElementById("arrow") as HTMLImageElement;
  public static catapultHTML = document.getElementById("catapult") as HTMLImageElement;
  public static lightningHTML = document.getElementById("lightning") as HTMLImageElement;
  
  public static drawCharacter1(context: CanvasRenderingContext2D,coorX:number,coorY:number,sizeFactor:number):void {
    ...
    public static drawCharacter4(context: CanvasRenderingContext2D,coorX:number,coorY:number,sizeFactor:number):void {
    ...
    public static drawCharacter2(context: CanvasRenderingContext2D,coorX:number,coorY:number,sizeFactor:number):void {
    ...
    public static drawCharacter2Aim(context: CanvasRenderingContext2D,coorX:number,coorY:number,position:string,sizeFactor:number) {
    ...
    public static drawCharacter3(context: CanvasRenderingContext2D,coorX:number,coorY:number,sizeFactor:number):void {
      //Eye Body
